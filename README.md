...
[LILYGO T5 4.7 inch e-Paper（ESP32-S3）](https://lilygo.cc/en-us/products/t5-4-7-inch-e-paper-v2-3) で、SD カードに保存した画像を選んで全画面に表示します。スマホから WiFi で送った画像も同じように表示できます。名刺やメモを入れておいて、場面に合わせて出し分ける、という使い方を想定しています。
...
| 画像から戻る | 画面をタップ / `BTN(IO21)` を押す | `BTN(IO21)` を押す |

## スマホから画像を送る

SD カードを抜き差ししなくても、スマホから直接画像を送れます。専用アプリは要りません。
